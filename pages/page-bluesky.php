...
<div id="wrapper" class="theme" style="background:url(<?php echo kratos_option('bibo_background')?>) no-repeat top center; padding-top:50px;background-color: white;background-attachment:fixed;background-size:100%;">
    <div class="wow tada">
        <header id="header" class="site-header">
            <section class="banner bg" style="background-image: url(<?php echo $profile['banner'] ?>)">
                <div class="big-title">
                    <h1 class="big-title-h1"><?php echo $profile['displayName'] ?>
                    ...
                    <h3 class="big-title-h3 tips-top" aria-label="<?php echo wp_strip_all_tags($profile['description']) ?>"><?php echo wp_strip_all_tags($profile['description']) ?></h3>
                </div>
                <div class="contactme">
                    <a target="_blank" href="https://bsky.app/profile/<?php echo $profile['handle'] ?>"><div class="weixin">Follow</div></a>
                </div>
            </section>
            <div class="touxiang">
                <a href="https://bsky.app/profile/<?php echo $profile['handle'] ?>" target="_top">
                ...
                <aside id="aside" class="left">
                    <div class="inner">
                        <div class="sns web-info wow bounceInLeft">
                            <li class="frinum">
                                <a href="https://bsky.app/profile/<?php echo $profile['handle'] ?>/follows"><?php echo $profile['followsCount'] ?>
                                    <span>Following</span></a>
                            </li>
                            <li class="vitnum">
                                <a href="https://bsky.app/profile/<?php echo $profile['handle'] ?>/followers"><?php echo $profile['followersCount'] ?>
                                    <span>Followers</span></a>
                            </li>
                            <li class="ptnum">
                                <?php echo $profile['postsCount'] ?>
                                <span>Posts</span>
                            </li>
                        </div>
                    </div>
                            ...
                            <div id="primary" class="list wow bounceInUp">
                                <article class="post">
                                    <div class="entry-header pull-left">
                                        <a href="https://bsky.app/profile/<?php echo $profile['handle'] ?>" target="_blank" class="user-head c-pointer" style="background-image: url(<?php echo $profile['avatar'] ?>); border-radius: 50%;"></a>
                                    </div>
                                    <div class="entry-content">
                                        <div class="meta">
                                            <div class="author" itemprop="author">
                                                <span class="author-name"><?php echo $profile['displayName'] ?></span>
                                            </div>
                                            <time class="author-time"><?php echo date('Y-m-d H:i:s', strtotime($post['indexedAt'])) ?></time>
                                        </div>
                                        <div class="summary" itemprop="description">
                                            <?php echo nl2br($post['record']['text']); ?>
                                            <?php if (isset($post['embed']['images'])) : ?>
                                                <div class="status-images" style="margin-top: 10px;">
                                                    <?php foreach ($post['embed']['images'] as $img) : ?>
                                                        <img class="content-img" src="<?php echo $img['fullsize'] ?>" style="max-width: 100%; margin-bottom: 5px;" />
                                                    <?php endforeach; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="status-webo">
                                        <ul class="items state">
                                            <li class="item fa fa-share-square-o"> <?php echo $post['repostCount'] ?></li>
                                            <li class="item fa fa-comment-o"> <?php echo $post['replyCount'] ?></li>
                                            <li class="item fa fa-thumbs-o-up"> <?php echo $post['likeCount'] ?></li>
                                        </ul>
                                    </div>
                                </article>
                            </div>
