...
<?php
//Receive post data here and judge
if(!empty($_REQUEST)) {
...
//        Got the required data
        ...
        echo "<script type='text/javascript'>alert('Application submitted successfully, please wait for the webmaster to review! You will receive an email notification after approval!');window.history.back(-1); </script>";
        //Send email
        $to=get_bloginfo('admin_email');
        $subject = 'New Friend Link Application!';
        $message='Name: '.$webname.'<br/>Website URL: '.$web.'<br/>Intro: '.$introduce.'<br/>Avatar Link: '.$avater.'<br/>Email: '.$mail;
                ...
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        <div class="kratos-post-content-l">
                            <h2 class="title-h2" style="text-align:center;font-size:18pt">Friends</h2>
                            <p style="text-align:center"><span style="color:#999999">Friend links, randomly ordered on every refresh~</span></p>
                            <div class="linkpage">
                                <hr/>
                                <ul><?php
                                ...
                                <button class="btn btn-success" data-toggle="modal" data-target="#myModal" style="border-radius: 4px;margin-bottom: 15px">Apply</button>
                                <!-- Modal -->
                                            ...
                                            <div class="modal-body">
                                                <form action=" " method="post" class="bs-example bs-example-form" role="form" style="text-align: center;">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="introduce" class="form-control" placeholder="Personal Intro">
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-file-image-o" aria-hidden="true"></i></span>
                                                        <input type="text" name="avater" class="form-control" placeholder="Avatar Link"></div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-envelope-o" aria-hidden="true"></i> </span>
                                                        <input type="text" name="mail" class="form-control" placeholder="Your Email (will be notified after addition)">
                                                    </div>
