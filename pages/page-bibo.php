<?php
/**
template name: BBilibili Dynamic Template
 */
                ...
                <div class="inner">
                    ...
                    <div class="sns master-info wow bounceInLeft">
                        <div class="person-info">
                            <li class="item">
                                <div class="row user-auth"><span title="<?php echo kratos_option('bibo_auth');?>" class="auth-description"><a href="https://space.bilibili.com/<?php echo $bilibilUid?>" title="Personal Auth" target="_blank" class="auth-icon personal-auth"></a><!---->
                            bilibiliPersonal Auth<br><?php echo kratos_option('bibo_auth');?>
                          </span></div>
                            </li>
                        </div>
                        <ul class="m_info-items">
                            ...
                            <?php if(kratos_option('bibo_descript')){?>
                                <li class="item">
                                    ...
                                    <span class="tips-right" aria-label="<?php echo kratos_option('bibo_descript');?>">Bio：<?php echo kratos_option('bibo_descript');?></span></li>
                            <?php }?>
                            <li class="item last">
                                <i class="icon louie-link-o"></i>
                                <a class="tips-right" aria-label="Custom Domain" href="<?php echo kratos_option('bibo_pushlink');?>" target="_blank"><?php echo kratos_option('bibo_push');?></a></li>
                        </ul>
                    ...
                    <div class="alteration wow zoomIn">
                        <div class="widget">
                            <h3 class="widget-title">
                                <i class="icon louie-notice"></i>Notice</h3>
                    ...
                    <?php }?>
                        <?php if(kratos_option('bibo_post')){?>
                            <div class="widget wow bounceInLeft">
                                <h3 class="widget-title">
                                    <i class="icon icon louie-smile"></i>Friend Links(Random10)</h3>
                        ...
                        <?php if(kratos_option('bibo_hot')){?>
                            <div class="widget wow bounceInLeft">
                                <h3 class="widget-title">
                                    <i class="icon louie-trend"></i>Hot Posts</h3>
        ...
        <div id="loop" class="right">
            ...
            <!-- Start here GetCount data-->
                ...
                foreach ($bilibililive->getlive($theid) as $content)
                {
                    ...
                    //The first line is the simplest text
                    if($realcontent["item"]["content"])
                    {
                        ...
                        //GetID No.，Convenient jump to dynamic
                        $id=$content['desc']['dynamic_id'];
                        //echo "VideoContent:".$realcontent["item"]["content"];
                    ...
                    {
                        //Differentiate content with images below
...
//                            echo "<br>aid No.".;
//                            echo "<br>cid No.".$realcontent["cid"];
//                            echo "<br>VideoDescription".$realcontent["desc"];
                        }
                    }
                }
                ?>
                <?php
                /*Here is 生成不同Type Content
                Content，Image Array，Shares，Likes，CommentsCount，Post Time，Views，Videocid，Videoaid，Type（1Plain Text 2Dynamic with images 3Posted Video）
                */
                function echoContent($content, $picture, $share, $like, $comment, $time, $visited, $cid, $aid, $option, $bilibililive, $bilibilUid,$id)
                {
                    /*Implement emoji and line break replacement here*/
                    $content=str_replace("\r\n","<br>",$content);
                    $content=str_replace("\n","<br>",$content);
                    ?>
                    <!-- Post List -->
