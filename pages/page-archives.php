<?php
/**
template name: ArchivesTemplate
*/
...
while($the_query->have_posts()):
    ...
    $output.='<div class="tl-body" ><li class="tl-item"><div class="tl-wrap b-'.$arr[$r].'"><span class="tl-date">'.get_the_time('d').''.'</span><h3 class="tl-content panel padder h5 l-h bg-'.$arr[$r].'"><span class="arrow arrow-'.$arr[$r].' left pull-up" aria-hidden="true"></span><a href="'.get_permalink().'" class="text-lt">'.get_the_title().'</a></h3></div></li></div>';
endwhile;
$output.='<li class="tl-header"><div class="btn btn-sm btn-default btn-rounded">Start</div></li>';
get_header(); ?>
                ...
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        <div class="kratos-post-content">
                            <div id="archives">
                                <h2 class="title-h2" style="text-align:center;font-size:18pt">Archives</h2>
                                <p style="text-align:center"><span style="color:#999">Total <?php echo wp_count_posts()->publish;echo ' public posts';echo wp_count_posts('page')->publish;echo' public pages。 (゜-゜)つロ Cheers~'?></span></p>
                            <hr/>
                                <h4>Tags</h4>
                                <div class="arc-tag">
                                <?php echo $arc_tags; ?>
