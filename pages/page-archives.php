                ...
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        <div class="kratos-post-content">
                            <div id="archives">
                                <h2 class="title-h2" style="text-align:center;font-size:18pt">Article Archives</h2>
                                <p style="text-align:center"><span style="color:#999">Currently there are <?php echo wp_count_posts()->publish;echo ' public posts';echo wp_count_posts('page')->publish;echo' public pages. (゜-゜)つロ Cheers~'?></span></p>
                            <hr/>
                                <h4>Tags</h4>
                                <div class="arc-tag">
                                <?php echo $arc_tags; ?>
