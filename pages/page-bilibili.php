<?php
/**
template name: bilibiliAnime Template
*/
get_header(); ?>
    ...
    <div class="page-header">
        <h1>My Anime
         <?php
            ...
            echo "<small>Currently following".$bili->sum." anime，Keep it up！</small></h1></div><div class=\"bilibili\">";
            function precentage($str1,$str2)
            {
                if(is_numeric($str1) && is_numeric($str2)) return $str1/$str2*100;
                else if ($str1=="No records!") return 0;
                else return 100;
            }
