...
- **Full PHP 8.4/8.5 & WordPress 7.0 Compatibility Overhaul**:
    - **Action**: Completed site-wide modernization of core logic and third-party integrations to ensure stable operation on PHP 8.4, PHP 8.5, and WordPress 7.0.
...
- **Fix**: Restored the English-localized `preg_split` implementation and updated the label to "X words" to ensure accurate counting and correct localization.
