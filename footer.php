            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3 footer-list text-center">
                    <p class="kratos-social-icons"><?php
                        ...
                        echo (!kratos_option('show_rss'))?'':'<a class="rss-tip" title="RSSSubscribe" target="_blank" rel="nofollow" href="';
...
<script type="text/javascript">
    /*Auto-refresh page to avoid access issues*/
