...
?>
                ...
                <div class="inner wow bounceInLeft">
                    ...
                    <div class="sns master-info">
                        <div class="person-info">
                            ...
                            bilibili Personal Auth<br><?php echo kratos_option('bibo_auth');?>
                          </span></div>
                            </li>
                        </div>
                    ...
                    <?php if(kratos_option('bibo_post')){?>
                            <div class="widget">
                                <h3 class="widget-title">
                                    <i class="icon icon louie-smile"></i>Friends (Random 10)</h3>
    ...
    <div id="loop" class="right">
            <!-- Enable flexible Waifu switching-->
            <style><?php
                ...
                <?php } ?>
                    ...
                    elseif(is_category()){
                        ...
                        if(kratos_option('show_head_tag')){ ?>
                            <div class="kratos-hentry clearfix">
                                <h1 class="kratos-post-header-title">Tags:<?php echo single_cat_title('',false); ?></h1>
                                <h1 class="kratos-post-header-title"><?php echo category_description(); ?></h1>
                            </div>
                        <?php }
                    }elseif(is_search()){ ?>
                    ...
                    if(have_posts()){
                        ...
                        <div class="kratos-hentry clearfix">
                            <h1 class="kratos-post-header-title">Sorry, nothing found.</h1>
                        </div>
                    <?php }
