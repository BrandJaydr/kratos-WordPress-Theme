 ...
 ?>
    ...
    <header id="header" class="site-header">
        ...
        <div class="banner-item width">
            <a class="active" href="https://space.bilibili.com/<?php echo $bilibilUid?>">My Home</a>
            <a href="https://space.bilibili.com/<?php echo $bilibilUid?>/album">My Album</a></div>
    </header>
                ...
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        ...
                        <div class="kratos-copyright text-center clearfix">
                            <h5>This work is licensed under  <a rel="license nofollow" target="_blank" href="http://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a> </h5>
                        </div>
                        <?php } ?>
