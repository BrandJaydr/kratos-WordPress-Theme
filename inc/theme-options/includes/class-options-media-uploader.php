...
class Options_Framework_Media_Uploader {
    ...
    static function optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
        ...
        $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="'.$name.'" value="' . $value . '" placeholder="' .'No file selected'.'" />' . "\n";
        if ( function_exists( 'wp_enqueue_media' ) ) {
            ...
            $output .= '<p><i>' .'Please update your WordPress version to get full media file support.'.'</i></p>';
        }
        if ( $_desc != '' ) {
