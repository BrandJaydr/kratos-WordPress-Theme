...
function kratos_comment_approved($comment){
    if(is_email($comment->comment_author_email)){
        ...
        $subject = '[通知] Your comment has been approved';
        $message = '
            ...
            <div style="background:#ececec;width:100%;padding:50px 0;text-align:center">
                <div style="background:#fff;width:750px;text-align:left;position:relative;margin:0 auto;font-size:14px;line-height:1.5">
                    ...
                    <div style="padding:35px 40px 30px">
                        ...
                        <p style="color:#313131;line-height:20px;font-size:15px;margin:20px 0">Your comment has been approved by the admin，Please see summary info below。</p>
                        ...
                        <br>
                        <div style="font-size:13px;color:#a0a0a0;padding-top:10px">该邮件由系统自动发出，如果不是您本人Action，请忽略此邮件。</div>
...
function comment_mail_notify($comment_id){
    ...
    if(($parent_id!='')&&($spam_confirmed!='spam')){
        ...
        $subject ='[通知] Your comment has a new reply';
        $message = '
            <style>img.wp-smiley{width:auto!important;height:auto!important;max-height:8em!important;margin-top:-4px;display:inline}</style>
            <div style="background:#ececec;width:100%;padding:50px 0;text-align:center">
                <div style="background:#fff;width:750px;text-align:left;position:relative;margin:0 auto;font-size:14px;line-height:1.5">
                    ...
                    <div style="padding:35px 40px 30px">
                        ...
                        <p style="color:#313131;line-height:20px;font-size:15px;margin:20px 0">You have a new reply to your comment，Please see summary info below。</p>
                        <table cellspacing="0" style="font-size:14px;text-align:center;border:1px solid #ccc;table-layout:fixed;width:500px">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="padding:5px 0;text-indent:8px;border:1px solid #eee;border-width:0 1px 1px 0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><a href="'.get_comment_link($comment->comment_ID).'" style="color:#1E5494;text-decoration:none;vertical-align:middle" target="_blank">View Reply</a></td>
                                </tr>
                            </tbody>
                        </table>
                        <br>
        ...
        <div style="background:#ececec;width:100%;padding: 50px 0;text-align:center">
            <div style="background:#fff;width:750px;text-align:left;position:relative;margin:0 auto;font-size:14px;line-height:1.5">
                ...
                <div style="padding:35px 40px 30px">
                    ...
                    <p style="color:#313131;line-height:20px;font-size:15px;margin:20px 0">Password Reset Request，Summary info is shown below。</p>
                    <table cellspacing="0" style="font-size:14px;text-align:center;border:1px solid #ccc;table-layout:fixed;width:500px">
                        <thead>
                            <tr>
        ...
        <div style="background:#ececec;width:100%;padding:50px 0;text-align:center">
            <div style="background:#fff;width:750px;text-align:left;position:relative;margin:0 auto;font-size:14px;line-height:1.5">
                ...
                <div style="padding:35px 40px 30px">
                    ...
                    <p style="color:#313131;line-height:20px;font-size:15px;margin:20px 0">Registration Successful，请使用下面的信息登录并修改密码。</p>
                    <table cellspacing="0" style="font-size:14px;text-align:center;border:1px solid #ccc;table-layout:fixed;width:500px">
                        <thead>
                            <tr>
