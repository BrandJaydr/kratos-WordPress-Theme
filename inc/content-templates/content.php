...
<?php }else{ ?>
<!-- The following section is all image code-->
...
<!--    This is a sticky post-->
    ...
    <div class="kratos-post-meta-new">
        ...
        <span class="pull-right">
            <a class="read-more" href="<?php the_permalink() ?>" title="<?php echo 'Read More' ?>"><?php echo 'Read More' ?> <i class="fa fa-chevron-circle-right"></i></a>
        </span>
    </div>
</div>
<?php } ?>
